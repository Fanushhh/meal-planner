...
const seedMeals: Array<{
  ...
  },
  {
    ...
    description: "Supă cremă de legume caldă servită cu un pahar de kefir.",
    servings: 1,
    prepTimeMin: 5,
    cookTimeMin: 15,
    ingredients: [
    ...
    instructions: [
      ...
      "Servește cu un pahar de kefir rece.",
    ],
  },
  {
    mealType: "lunch",
  ...
  // ── Cină ──────────────────────────────────────────────────
  {
    ...
    description:
      "Supă cremă de legume servită cu bacon crocant prăjit fără ulei.",
    servings: 1,
    prepTimeMin: 5,
    cookTimeMin: 15,
    ingredients: [
      { quantity: 1, unit: "bol", name: "supă cremă de legume" },
      { quantity: 30, unit: "g", name: "bacon" },
    ],
    instructions: [
      "Încălzește supa cremă de legume.",
      "Prăjește baconul în tigaie fără ulei până devine crocant.",
      "Servește supa cu baconul crocant deasupra.",
    ],
  },
  {
    mealType: "dinner",
